// Document modified at : Sunday, December 07, 2003 6:16:44 PM , by user : omega , from computer : ALYSON
//
...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"60 192 200 255"	// used in text windows, lists
		"BrightBaseText"	"0 176 255 255"	// brightest text
		"SelectedText"		"0 176 255 255"	// selected text
		"DimBaseText"		"0 176 255 255"	// dim base text
		"LabelDimText"		"0 176 255 164"	// used for info text
		"ControlText"		"0 176 255 255"	// used in all text controls
		...
		// background colors
		"ControlBG"			"0 0 0 60"		// background color of controls
		"ControlDarkBG"		"0 0 0 160"		// darker background color; used for background of scrollbars
		"WindowBG"			"0 0 0 200"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"0 28 192 140"	// background color of any selected text or menu item
		"SelectionBG2"		"70 12 0 40"		// selection background in window w/o focus
		"ListBG"			"0 0 0 128"		// background of scoreboard
		"ViewportBG"		"55 43 29 140"

		// titlebar colors
		"TitleText"			"0 174 255 255"
		"TitleDimText"		"0 174 255 255"
		"TitleBG"			"100 0 0 80"
		"TitleDimBG"		"100 0 0 60"
		...
		"BorderSelection"	"0 112 188 0"	// the additional border color for displaying the default/selected button		// base colors

		"team0"			"255 255 255 255" //spectator/free for all
		//todo: make these colors.
		"team1"			"76 102 76 255" //red
		"team2"			"255 64 64 255" //green
		"team3"			"255 179 0 255" //blue
		"team4"			"255 179 0 255" //orange
