// Document modified at : Sunday, December 07, 2003 6:26:40 PM , by user : omega , from computer : ALYSON
//
...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"201 69 59 255"	// used in text windows, lists
		"BrightBaseText"	"255 1 1 255"	// brightest text
		"SelectedText"		"255 1 1 255"	// selected text
		"DimBaseText"		"255 1 1 255"	// dim base text
		"LabelDimText"		"255 1 1 164"	// used for info text
		"ControlText"		"255 1 1 255"	// used in all text controls
		...
		"ControlDarkBG"		"0 0 0 220"		// darker background color; used for background of scrollbars
		"WindowBG"			"0 0 0 240"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"100 28 0 240"	// background color of any selected text or menu item
		"SelectionBG2"		"70 12 0 230"		// selection background in window w/o focus
		"ListBG"			"0 0 0 200"		// background of scoreboard
		"ViewportBG"		"55 43 29 140"

		// titlebar colors
		"TitleText"			"255 1 1 255"
		"TitleDimText"		"255 1 1 255"
		"TitleBG"			"100 0 0 250"
		"TitleDimBG"		"100 0 0 220"
	...
	BaseSettings
	{
		...
		"TitleBarIcon"				"resource/icon_hhd"
		"TitleBarDisabledIcon"		"resource/icon_hhd_disabled"
